...
declare const _default: ({
    ...
    plugins: {
        '@typescript-eslint': {
            configs: Record<string, tseslintParser>;
            meta: tseslintParser;
            rules: typeof import("@typescript-eslint/eslint-plugin/rules");
        };
        import: import("@eslint/core").Plugin & {
            meta: {
                name: string;
                version: string;
            };
        ...
        unicorn: import("@eslint/core").Plugin & {
            configs: {
                recommended: import("eslint").Linter.FlatConfig;
        ...
        sonarjs: {
            ...
            configs: {
                recommended: import("eslint").Linter.FlatConfig<import("eslint").Linter.RulesRecord>;
                "recommended-legacy": import("eslint").Linter.LegacyConfig<import("eslint").Linter.RulesRecord, import("eslint").Linter.RulesRecord>;
            };
            meta: {
                name: string;
                version: string;
