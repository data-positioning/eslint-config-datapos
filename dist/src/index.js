...
const tsconfigRootDirectory = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..');
// Exposures - Configuration.
export default [
    { ignores: ['dependency-check-bin/**', 'dependency-check-reports/**', 'dist/**', 'stats/**'] },
    {
        files: ['eslint.config.ts', 'index.ts', 'src/**/*.ts', 'vite.config.ts'],
        languageOptions: {
            parser: tseslintParser,
            parserOptions: { project: ['./tsconfig.eslint.json'], tsconfigRootDir: tsconfigRootDirectory }
        },
        plugins: {
